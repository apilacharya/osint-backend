...
import { collectFindings } from "../../services/aggregation/aggregation.service.js";
import { resolveEntityFindings } from "../../services/resolution/entity-resolution.service.js";
...
import { upsertEntity } from "../entities/entity.service.js";
const getProcessedFindings = async (input) => {
...
export const runAuthenticatedSearch = async (input, userId) => {
...
export const runGuestSearch = async (input) => {
    const now = new Date();
...
export const listSearchRuns = async (filters, userId) => {
    const where = {
        userId,
        ...(filters.query
            ? {
...
export const getSearchRunById = async (id, userId, filters) => {
